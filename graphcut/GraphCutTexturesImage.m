function [ outputImage, outputImagePatchLabels] = GraphCutTexturesImage( outputImage,   patch, offset, ...
                                           outputImagePatchLabels,label )
% global patch;   
...
%     disp('Finding the seam...');
    ...
    mask = findSeam(patchOnBackground, patchOnBackgroundMask, outputImagePatchLabels,patch, offset,outputImage);
...
%% Helper functions. The actual program begins after these functions
    ...
    % offset
    function mask = findSeam(patchOnBackground, patchOnBackgroundMask,outputImagePatchLabels, patch,offset,outputImage)
